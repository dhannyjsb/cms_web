                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <?php echo form_open_multipart(base_url($request->uri->getSegment(1) . '/profile/upload_foto'), 'novalidate id="form_photo"'); ?>
                                        ...
                                        <?php echo form_open(base_url($request->uri->getSegment(1) . '/profile'), 'novalidate id="form_profile"'); ?>
                                        <div class="row">
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label>Username</label>
                                                        <input type="text" name="nama_lengkap" class="form-control" placeholder="nama_lengkap" value="<?= esc($user_info['nama_lengkap']); ?>" required data-validation-required-message="This username field is required">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="controls">
