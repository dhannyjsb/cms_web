                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label>Status PTK</label>
                                        <select class="column_filter select2 form-control" id="column_filter" data-column="5">
                                            <option value="">Semua Kelas</option>
                                            <?php foreach ($semua_status as $semua_status) : ?>
                                                <option data-column="5" value="<?= $semua_status['status_kepegawaian'] ?>"><?= $semua_status['status_kepegawaian'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
...
<script type="text/javascript">
    function lihat_modal_siswa(id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('admin/siswa/view_single'); ?>",
            data: dataJson,
