                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Surat Ekstrakulikuler
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <section class="row">
                                <div class="col-md-8">
                                    <div class="h4">Surat Ekstrakulikuler Tahun 2020</div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <table id="table_surat_extra" class="table table-striped table-bordered dt-responsive" style="width:100%">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" name="penghapus_surat_extra" class="form-control" id="penghapus_surat_extra" value="<?= $user_info['id_unik']; ?>">
...
<?php echo form_open_multipart(base_url($request->uri->getSegment(1) . '/tu/surat_extra'), 'class="form-horizontal" id="form_tambah_surat_extra"');  ?>
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Surat Ekstrakulikuler</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="tanggal_surat_extra" class="form-control format_tanggal">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="tahun_surat_extra" placeholder="PERIHAL SURAT" value="2020">
                    <input type="hidden" class="form-control" name="pembuat_surat_extra" value="<?= $user_info['id_unik']; ?>">
...
<div class="modal fade view_modal_data" id="view_modal_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Surat Ekstrakulikuler</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?php echo form_open(base_url($request->uri->getSegment(1) . '/tu/simpan_edit_surat_extra'), 'class="form-horizontal" id="form_edit_surat_extra"');  ?>
...
<script>
    $(document).ready(function() {
        ...
        var list_surat_extra = $("#table_surat_extra").DataTable({
            processing: true,
            responsive: true,
            dom: "lrtip",
            lengthChange: false,
            ...
            columns: [{
                ...
                {
                    orderable: false,
                    data: "second_surat_extra"
                },

                {
                    orderable: false,
                    data: "no_berkas_extra"
                },
                {
                    orderable: false,
                    data: "perihal_surat_extra"
                },
                {
                    orderable: false,
                    data: "alamat_surat_extra"
                },
                {
                    orderable: false,
                    data: "tanggal_surat_extra"
                },
                {
                    orderable: false,
                ...
                },
                {
                    ...
                    data: function(row, type, set) {
                        if (<?= $user_info['user_role_id']; ?> == 1) {
                            return (
                                '<button class="btn btn-info btn-sm editRecord" onclick="modal_edit_surat_extra(' +
                                row.surat_extra_id +
                                ...
                                '" data-nama="' +
                                row.no_surat_extra +
                                row.second_surat_extra +
                                '" id="ajax-request">Hapus</button>'
                            );
                        } else {
                            if (row.pembuat_surat_extra == "<?= $user_info['id_unik']; ?>") {
                                return (
                                    '<button class="btn btn-info btn-sm editRecord" onclick="modal_edit_surat_extra(' +
                                    row.surat_extra_id +
                                    ')" data-toggle="modal" data-target=".view_modal_data">Edit</button>' +
        ...
        list_surat_extra.order([0, "desc"], [1, "desc"]).draw();

        $("#list_surat_extra").on("click", ".editSurat", function() {
        ...
        $("#list_surat_extra").on("click", ".deleteRecord", function() {
            var UserId = $(this).data("id");
            var nama_data = $(this).data("nama");
        ...
        $("#deleteUserForm").on("submit", function() {
            ...
            var penghapus_surat_extra = $("#penghapus_surat_extra").val();
            var token = $('input[name="csrf_token_web"]').attr("value");
            $.ajax({
                type: "POST",
                url: "hapus_surat_extra",
                dataType: "JSON",
                data: {
                    id: UserId,
                ...
                success: function(data) {
                    if (data == false) {
                        ...
                        $("#deleteUserId").val("");
                        $("#deleteUserModal").modal("hide");
                        list_surat_extra.ajax.reload(function() {});
                    }
                },
            });
            return false;
        ...
        var form_tambah_surat_extra = $("#form_tambah_surat_extra").attr("action");
        $("#form_tambah_surat_extra").submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result == 1) {
                        ...
                        $("#form_tambah_surat_extra")[0].reset();
                        list_surat_extra.ajax.reload(function() {});
                        Swal.fire({
                            position: "top-end",
                            type: "success",
        ...
        var form_edit_surat_extra = $("#form_edit_surat_extra").attr("action");
        $("#form_edit_surat_extra").submit(function(e) {
            e.preventDefault();
            var formData = new FormData(this);
            $.ajax({
                url: form_edit_surat_extra,
                type: "post",
                data: formData,
                processData: false,
                contentType: false,
...
<script type="text/javascript">
    function modal_edit_surat_extra(id) {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url($request->uri->getSegment(1) . '/tu/edit_surat_extra'); ?>",
            data: dataJson,
