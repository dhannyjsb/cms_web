    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type=" text" class="form-control" name="no_surat" placeholder="NO SURAT" value="<?= esc($data_surat['no_surat_extra']); ?>" required>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                <label style="text-align: center;display: block;">KODE SURAT</label>
                <input type="text" class="form-control" name="kode_surat" placeholder="KODE SURAT" value="<?= esc($data_surat['second_surat_extra']); ?>" required>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="no_berkas" placeholder="NO BERKAS" value="<?= esc($data_surat['no_berkas_extra']); ?>" required>
                <input type="hidden" class="form-control" name="surat_extra_id" placeholder="NO BERKAS" value="<?= esc($data_surat['surat_extra_id']); ?>" required>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type='text' name="tanggal_surat_extra" class="form-control format_tanggal" value="<?= esc($data_surat['tanggal_surat_extra']); ?>" required>
            </div>
        </div>
    </div>
    <div class="form-group">
        <label style="text-align: center;display: block;">ALAMAT TUJUAN</label>
        <input type="text" class="form-control" name="tujuan_surat" placeholder="ALAMAT TUJUAN" value="<?= esc($data_surat['alamat_surat_extra']); ?>" required>
    </div>
    <div class="form-group">
        <label style="text-align: center;display: block;">PERIHAL SURAT</label>
        <input type="text" class="form-control" name="perihal_surat" placeholder="PERIHAL SURAT" value="<?= esc($data_surat['perihal_surat_extra']); ?>" required>
        <input type="hidden" class="form-control" name="tahun_surat_extra" placeholder="PERIHAL SURAT" value="2020">
        <input type="hidden" class="form-control" name="pengedit_surat_extra" placeholder="PERIHAL SURAT" value="<?= esc($user_info['id_unik']); ?>">
