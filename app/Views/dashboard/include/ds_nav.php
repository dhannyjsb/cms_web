            ...
            <div class="navbar-collapse" id="navbar-mobile">
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    ...
                    <ul class="nav navbar-nav bookmark-icons">
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600"><?= esc($settings['nama_sekolah']); ?>, <?= $tahun_sedang_aktif; ?></span><span class="user-status">
                    </ul>
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="<?= base_url(); ?>"><i class="ficon feather icon-globe"></i></a>
                    </li>
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600"> <?= esc($user_info['nama_lengkap']); ?></span><span class="user-status">
                                    <?= esc($user_info['nama_role']); ?>
                                </span></div><span><img class="round" src="<?php echo base_url(); ?>/perpustakaan_file/profile_photo/<?= esc($user_info['image']); ?>" alt=" avatar" height="40" width="40"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="<?php echo base_url(); ?>/<?= $request->uri->getSegment(1); ?>/profile"><i class="feather icon-user"></i> Edit Profile</a><a class="dropdown-item" href="app-email.html"><i class="feather icon-mail"></i> My Inbox</a><a class="dropdown-item" href="app-todo.html"><i class="feather icon-check-square"></i> Task</a><a class="dropdown-item" href="app-chat.html"><i class="feather icon-message-square"></i> Chats</a>
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="<?php echo base_url(); ?>/logout"><i class="feather icon-power"></i> Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
