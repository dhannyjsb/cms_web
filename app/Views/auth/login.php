                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <?php if (session()->getflashdata('no_db')) { ?>

                                            <div class="alert alert-warning alert-dismissible mb-2" role="alert">
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                                                <p class="mb-0">
                                                    <p><?= session()->getflashdata('no_db') ?></p>
                                                </p>
                                            </div>
                                        <?php } ?>
                                        <?php if (session()->getflashdata('buat_db')) { ?>
                                            <div class="alert alert-success alert-dismissible mb-2" role="alert">
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                                                <p class="mb-0">
                                                    <p><?= session()->getflashdata('buat_db') ?></p>
                                                </p>
                                            </div>
                                        <?php } ?>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                ...
                                                <div class="form-group">
                                                    <select name="mode_akun" data-placeholder="Pilih akun" class="select2-icons form-control" id="select2-icons">
                                                ...
                                                <?php if ($cek_db == 0) { ?>
                                                    <a class="btn btn-danger float-left btn-inline waves-effect waves-light" href="<?= base_url('init'); ?>"> Buat Table</a>
                                                <?php } ?>
                                        ...
                                        <div class="login-footer">
                                            <div class="divider">
                                                <div class="divider-text">Bermasalah?</div>
                                            </div>
